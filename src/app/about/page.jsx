...
import { ArrowLeft, Download, MapPin, Calendar, Github, Linkedin, Mail, Phone, Menu, X } from "lucide-react"
  ...
  return (
    <div className="min-h-screen bg-teal-950 text-emerald-100 page-enter">
      ...
      <button
        ...
        className="fixed bottom-6 left-6 z-[9999] bg-emerald-400 text-teal-950 p-3 rounded-full shadow-2xl hover:bg-emerald-300 transition-all duration-300 hover:scale-110 active:scale-95 flex items-center justify-center"
